  ...
  return {
    ...
    event_init: function() {
      ...
      $("#ib-file-save").live("click", function() {
        ...
        if (indexes.length == 0) {
          ARIA2.main_alert("alert-error", "至少选择一个文件或者停止任务", 5000);
        } else {
          var options = {
      ...
      view: {
        ...
        error_msg: function() {
          var error_code_map = {
            ...
            11: "aria2 正在下载同一个文件",
            12: "aria2 正在下载同一个BT",
            13: "文件已存在。 See --allow-overwrite option.",
            14: "重命名文件失败。 See --auto-file-renaming option.",
            15: "aria2 不能打开已存在文件",
            16: "aria2 不能创建新文件 or truncate existing file.",
            17: "I/O 错误（磁盘读写错误）",
            18: "aria2 不能创建目录",
            19: "名称解析失败",
            20: "无法解析Metalink文件",
